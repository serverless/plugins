...
| **[Serverless Kubeless](https://github.com/bitnami/kubeless-serverless)** <br/> Serverless plugin for deploying functions to Kubeless. | [bitnami](http://github.com/bitnami) | 
...
| **[Serverless Plugin Elastic Beanstalk](https://github.com/rawphp/serverless-plugin-elastic-beanstalk.git)** <br/> A serverless plugin to deploy applications to AWS ElasticBeanstalk. | [rawphp](http://github.com/rawphp) | 
...
| **[Serverless Plugin Stack Config](https://github.com/rawphp/serverless-plugin-stack-config.git)** <br/> A serverless plugin to manage configurations for a stack across micro-services. | [rawphp](http://github.com/rawphp) | 
